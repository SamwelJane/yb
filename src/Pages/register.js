          ...
          <div className="col-12 col-md-9 col-lg-7 col-xl-6">
            ...
            <div className="container bg-white rounded mt-2 mb-2 px-0">
              ...
              <div className="mx-0 px-0 bg-light">
                ...
                <div className="pt-2">
                  <div className="row justify-content-center">
                    <h5>You have an Account?<span><Link to="/Login" className="text-danger"> Login Now!</Link></span></h5>
                  </div>
                  <div className="row justify-content-center align-items-center pt-4 pb-5">
                    <div className="col-4"> <Link to="/Login" className="btn btn-block btn-info"> LOGIN </Link> </div>
                  </div>
                </div>
              </div>
            </div>
